...
services:
  sungrowmodbus2mqtt:
    ...
    image: ghcr.io/jesseklm/sungrowmodbus2mqtt:v1.0.18
    restart: unless-stopped
    volumes:
      - ./config.sh10rt.yaml:/config/config.yaml:ro
```

- `wget -O config.sh10rt.yaml https://raw.githubusercontent.com/jesseklm/sungrowmodbus2mqtt/v1.0.18/config.sh10rt.example.yaml`
